"""
Django settings for medsurvey_site project.
...
SECRET_KEY = 'django-insecure-1g*%zwsp)@a(qqj*atkq8%z1bzv1#)svhhnb_7k@4&jx!rgx5n'
...
ROOT_URLCONF = 'medsurvey_site.urls'
...
WSGI_APPLICATION = 'medsurvey_site.wsgi.application'
